...
document.getElementsByClassName('homepage')[0].addEventListener('mousemove', updateMousePos);
document.getElementsByClassName('homepage')[0].addEventListener('pointermove', updateMousePos, { passive: true });
...
export class GooCursor {
    ...
    initEvents() {
        ...
        document.getElementsByClassName('homepage')[0].addEventListener('mousemove', handleMove);
        document.getElementsByClassName('homepage')[0].addEventListener('pointermove', handleMove, { passive: true });
    }
